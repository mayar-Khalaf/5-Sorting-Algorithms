...
list_sizes_to_test = [100, 500, 1000, 5000, 10000]

print("SORTING SPEED TEST - ALREADY SORTED NUMBERS")
print("==============================================")
print()
...
for size in list_sizes_to_test:
    ...
    print(f"Sorting a list of {size} ALREADY SORTED numbers:")

    time_taken = measure_sort_time(bubble_sort, sorted_numbers)
    print(f"   Bubble Sort:    {time_taken:.3f} ms")

    time_taken = measure_sort_time(insertion_sort, sorted_numbers)
    print(f"   Insertion Sort: {time_taken:.3f} ms")

    time_taken = measure_sort_time(selection_sort, sorted_numbers)
    print(f"   Selection Sort: {time_taken:.3f} ms")

    time_taken = measure_sort_time(merge_sort, sorted_numbers)
    print(f"   Merge Sort:     {time_taken:.3f} ms")

    time_taken = measure_sort_time(quick_sort, sorted_numbers)
